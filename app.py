...
# Keeps the model from your Colab code. You can change it in Render
# with the GEMINI_MODEL environment variable if needed.
...
- Topics can include Computer Science, Programming, DBMS,
  ...
  Cloud Computing, Software Engineering, Physics, Chemistry,
...
tools = [calculator, study_planner, topic_explainer]
...
1. If the user asks something unrelated to student assistance, do NOT answer it.
   Respond exactly:
...
3. Use the calculator tool whenever a mathematical calculation is required.

4. Use the study_planner tool when the student asks for a study plan.

5. Use the topic_explainer tool for academic or educational topic questions.
...
def ask_agent(user_input):
    ...
    return clean_answer(response["messages"][-1].content)
...
<div class="box">
    ...
    <p>Ask an academic question, calculate something, or request a study plan.</p>

    <textarea id="message" placeholder="Example: Make a 5-day study plan for DBMS and OS"></textarea>
